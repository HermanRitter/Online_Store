            ...
            <div className={styles.container}>
                <div className={styles.adminBox}>
                    <div className={styles.adminItem}>
                        ...
                        <button onClick={() => setTypeVisible(true)} className={styles.adminButton}>
                    ...
                    <div className={styles.adminItem}>
                        ...
                        <button onClick={() => setDeviceVisible(true)} className={styles.adminButton}>
                            <img className={styles.adminButtonImg} src={addImage} alt=""/>
                        </button>
                    </div>
                    <div className={styles.adminItem}>
                        ...
                        <button onClick={() => setBrandVisible(true)} className={styles.adminButton}>
                            <img className={styles.adminButtonImg}  src={addImage} alt=""/>
                        </button>
                    </div>
                </div>
